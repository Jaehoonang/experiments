...
class weight_MMDWT_UNet_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        high_values, high_indices = torch.sort(difference_annot_high.view(-1))
        high_k = int((1 - self.mask_ratio) * len(high_values))
        threshold = high_values[high_k]
        high_mask = (difference_annot_high >= threshold).float()
...
class ex1_MMDWT_UNet_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        masekd_ll_dal1 = modal1_LL * total_ll_mask
        masekd_ll_dal2 = modal2_LL * total_ll_mask

        masekd_high_dal1 = modal1_High * total_high_mask
        masekd_high_dal2 = modal2_High * total_high_mask
